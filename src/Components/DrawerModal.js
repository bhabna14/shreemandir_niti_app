import { StyleSheet, Text, View, Modal, TouchableWithoutFeedback, TouchableOpacity, Alert, Image, Pressable } from 'react-native'
                ...
                <TouchableWithoutFeedback onPress={onClose}>
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
                        <View style={styles.variantModalContainer}>
                            ...
                            <TouchableOpacity style={styles.drawerCell} onPress={() => { navigation.navigate('ManualNitiPage'), onClose() }}>
                            ...
                            <TouchableOpacity style={styles.drawerCell} onPress={() => { navigation.navigate('Home'), onClose() }}>
                                <View style={{ width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}>
                                    <Image style={{ height: 30, width: 30 }} source={require("../assets/images/darshan.png")} />
                                </View>
                            ...
                            <TouchableOpacity style={styles.drawerCell}>
                                <View style={{ width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' }}>
                                    <Image style={{ height: 25, width: 25 }} source={require("../assets/images/donation435.png")} />
                                </View>
